...
Latency sensitivity cannot be exactly recomputed from compact aggregate rows. Runtime watcher interval is configured at `10` seconds and active in Docker.
