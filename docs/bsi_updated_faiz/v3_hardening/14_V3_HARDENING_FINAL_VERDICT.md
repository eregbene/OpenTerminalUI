...
Final verdict: V3 planned-entry remains directionally promising, but exact Jan-Aug trustworthiness requires an instrumented hardened replay because the existing artifact is compact.
